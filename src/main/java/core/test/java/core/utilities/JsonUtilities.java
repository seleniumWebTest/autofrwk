...
public class JsonUtilities {
	private static Logger log = Logger.getLogger(JsonUtilities.class);
	...
	public static DesiredCapabilities convertJsonToCapabilities(String json) {
		...
		Map<String, String> caps = JsonUtilities.convertJsonToMap(json);
		if (caps != null) {
	...
	public static List<String> convertJsonToArguments(String json) {
		...
		Map<String, String> maps = JsonUtilities.convertJsonToMap(json);
		if (maps != null) {
