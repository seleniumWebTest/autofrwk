...
import core.test.java.core.report.ExtentTestManager;
...
public class Logger {
	...
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(Logger.class);
